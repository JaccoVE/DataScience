...
# Folder Locations
f_road <- "/home/jacco/Documents/Git/DataScience/DatabaseWithDate (Revision)/road_data.csv"
f_meta <- "/home/jacco/Documents/Git/DataScience/DatabaseWithDate (Revision)/metaRoad.csv"
